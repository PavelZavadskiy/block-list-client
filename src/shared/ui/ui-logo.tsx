...
export const Shield = ({ className }: { className?: string }) => {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64">
      <path
        fill="#728084"
      ...
      <path fill="#89969b" d="M50.9 8.6c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.3-.7.5-1.1.5" />
      <circle cx="54.3" cy="21.2" r="1.4" fill="#b0bdc6" />
      <circle cx="54.3" cy="21.2" r="1.1" fill="#dfe9ef" />
      <path fill="#89969b" d="M54.3 21.8c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.3-.7.5-1.1.5" />
      ...
      <path fill="#89969b" d="M32 61.3c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.3-.7.5-1.1.5" />
      <circle cx="20" cy="50.5" r="1.4" fill="#b0bdc6" />
      <circle cx="20" cy="50.5" r="1.1" fill="#dfe9ef" />
      <path fill="#89969b" d="M20 51c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.4-.7.5-1.1.5" />
      <circle cx="11.7" cy="37.7" r="1.4" fill="#b0bdc6" />
      <circle cx="11.7" cy="37.7" r="1.1" fill="#dfe9ef" />
      <path fill="#89969b" d="M11.7 38.2c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.3-.7.5-1.1.5" />
      <circle cx="9.7" cy="21.2" r="1.4" fill="#b0bdc6" />
      <circle cx="9.7" cy="21.2" r="1.1" fill="#dfe9ef" />
      <path fill="#89969b" d="M9.7 21.8c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.3-.7.5-1.1.5" />
      <circle cx="13.1" cy="8" r="1.4" fill="#b0bdc6" />
      <circle cx="13.1" cy="8" r="1.1" fill="#dfe9ef" />
      <path fill="#89969b" d="M13.1 8.6c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1c.6 0 1-.4 1.1-1c-.3.3-.7.5-1.1.5" />
    </svg>
  );
};
